...
public interface Bank extends Remote {
     ...
     */
    public AccountDTO getAccount(String name) throws RemoteException, BankAccountNotFoundException;
     ...
     *                           update.
     */
    public void deposit(AccountDTO acct, int amt) throws RemoteException, RejectedException, BankAccountNotFoundException;
